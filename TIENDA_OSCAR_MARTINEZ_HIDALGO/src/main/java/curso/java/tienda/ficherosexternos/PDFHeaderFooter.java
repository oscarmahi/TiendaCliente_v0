...
public class PDFHeaderFooter extends PdfPageEventHelper {
    ...
    public void onStartPage(PdfWriter writer, Document document) {
        ...
        //System.out.println(applicationPath+"\\src\\main\\webapp\\imagenes\\logo-blue-2.jpg");
    	...
    	try {
	    	...
	    	//imagen
    		//Obtenemos la imagen
    		imagen = Image.getInstance(ruta+"imagenes/logo-blue-2.jpg");
	    	//System.out.println(applicationPath+"\\src\\main\\webapp\\imagenes\\logo-blue-2.jpg");
    		//imagen = Image.getInstance(applicationPath+"\\src\\main\\webapp\\imagenes\\logo-blue-2.jpg");
    		//System.out.println(applicationPath+"\\src\\main\\webapp\\imagenes\\logo-blue-2.jpg");
	    	...
	    	//texto
    		//Agregamos un texto
    		txtCabecera = new Phrase("Factura de Venta");
			...
			System.out.println("excepcion en PDFHeaderFooter");
			e.printStackTrace();
		}
